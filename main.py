...
/quickadd - Швидко додати зустріч однією командою
...
Тепер quickadd працює як повноцінний діалог:
- 📅 Вибір дати через кнопки (сьогодні/завтра/інша)
- 🕐 Вибір часу через кнопки або введення свого
- 🏷️ Вибір тегу
- ⏰ Вибір кількох нагадувань
